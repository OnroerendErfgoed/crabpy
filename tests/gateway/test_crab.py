...
class TestCrabGateway:
    def test_list_gewesten(self, crab_gateway, crab_service):
        crab_service.ListGewesten.return_value = Mock(
            GewestItem=[Mock(GewestId=1, TaalCodeGewestNaam="NL", GewestNaam="Vlaams")]
        )
    ...
    def test_list_gemeenten_default(self, crab_gateway, crab_service):
        ...
        crab_service.ListGemeentenByGewestId.return_value = Mock(
            GemeenteItem=[
                Mock(
                    GemeenteId=1,
                    NISGemeenteCode=10000,
                    TaalCode="NL",
                    TaalCodeGemeenteNaam="NL",
                )
            ]
        )
    ...
    def test_list_gemeenten_by_provincie(self, crab_gateway, crab_service):
        crab_service.GetGewestByGewestIdAndTaalCode.return_value = Mock(GewestId=2)
        crab_service.ListGemeentenByGewestId.return_value = Mock(
            GemeenteItem=[
                Mock(
                    GemeenteId=1,
    ...
    def test_get_gemeente_by_id_with_string(self, crab_gateway, crab_service):
        crab_service.GetGemeenteByGemeenteId.side_effect = GatewayRuntimeException(
            None, None
        )
    ...
    def test_list_aardterreinobjecten(self, crab_gateway, crab_service):
        crab_service.ListAardTerreinobjecten.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_statushuisnummers(self, crab_gateway, crab_service):
        crab_service.ListStatusHuisnummers.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_statussubadressen(self, crab_gateway, crab_service):
        crab_service.ListStatusSubadressen.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_statusstraatnamen(self, crab_gateway, crab_service):
        crab_service.ListStatusStraatnamen.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_statuswegsegmenten(self, crab_gateway, crab_service):
        crab_service.ListStatusWegsegmenten.return_value = Mock(CodeItem=[Mock()])
        res = crab_gateway.list_statuswegsegmenten()
        assert isinstance(res, list)
        assert isinstance(res[0], Statuswegsegment)

    def test_list_geometriemethodewegsegmenten(self, crab_gateway, crab_service):
    ...
    def test_list_gemetriemethodegebouwen(self, crab_gateway, crab_service):
        crab_service.ListGeometriemethodeGebouwen.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_herkomstadrespositie(self, crab_gateway, crab_service):
        crab_service.ListHerkomstAdresposities.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_huisnummers_by_straat(self, crab_gateway, crab_service):
        crab_service.ListHuisnummersWithStatusByStraatnaamId.return_value = Mock(
    ...
    def test_list_huisnummers_by_straat_empty(self, crab_gateway, crab_service):
        crab_service.ListHuisnummersWithStatusByStraatnaamId.return_value = Mock(
            HuisnummerWithStatusItem=[]
        )
    ...
    def test_list_huisnummers_by_perceel(self, crab_gateway, crab_service):
        crab_service.ListHuisnummersWithStatusByIdentificatorPerceel.return_value = Mock(
            HuisnummerWithStatusItem=[Mock(HuisnummerId=1)]
        )
    ...
    def test_list_huisnummers_by_perceel_empty(self, crab_gateway, crab_service):
        crab_service.ListHuisnummersWithStatusByIdentificatorPerceel.return_value = Mock(
            HuisnummerWithStatusItem=[]
        )
    ...
    def test_get_huisnummer_by_nummer_and_straat(self, crab_gateway, crab_service):
        crab_service.GetHuisnummerWithStatusByHuisnummer.return_value = Mock(
            HuisnummerId=1, BeginBewerking=1, BeginOrganisatie=1, Huisnummer="1"
        )
        crab_service.GetStraatnaamWithStatusByStraatnaamId.return_value = Mock(
            StraatnaamId=1, BeginBewerking=1, BeginOrganisatie=1
        )
    ...
    def test_get_huisnummer_by_unexisting_nummer_and_straat(
    ...
    def test_list_postkantons_by_gemeente_empty(self, crab_gateway, crab_service):
        crab_service.ListPostkantonsByGemeenteId.return_value = Mock(PostkantonItem=[])
        res = crab_gateway.list_postkantons_by_gemeente(0)
        assert isinstance(res, list)
        assert len(res) == 0

    def test_get_postkanton_by_huisnummer(self, crab_gateway, crab_service):
        crab_service.GetPostkantonByHuisnummerId.return_value = Mock(PostkantonCode=1)
    ...
    def test_get_postkanton_by_unexisting_huisnummer(self, crab_gateway, crab_service):
    ...
    def test_list_wegobjecten_by_straat(self, crab_gateway, crab_service):
        crab_service.ListWegobjectenByStraatnaamId.return_value = Mock(
            WegobjectItem=[Mock(IdentificatorWegobject=1, AardWegobject=1)]
        )
    ...
    def test_list_wegobjecten_by_unexsiting_straat(self, crab_gateway, crab_service):
        crab_service.ListWegobjectenByStraatnaamId.return_value = Mock(WegobjectItem=[])
    ...
    def test_get_wegobject_by_id(self, crab_gateway, crab_service):
        crab_service.GetWegobjectByIdentificatorWegobject.return_value = Mock(
            IdentificatorWegobject="53839893", BeginBewerking=1, BeginOrganisatie=1
        )
    ...
    def test_list_wegsegmenten_by_straat_empty(self, crab_gateway, crab_service):
        crab_service.ListWegsegmentenByStraatnaamId.return_value = Mock(WegsegmentItem=[])
        res = crab_gateway.list_wegsegmenten_by_straat(0)
        assert isinstance(res, list)
        assert len(res) == 0

    def test_get_wegsegment_by_id(self, crab_gateway, crab_service):
        crab_service.GetWegsegmentByIdentificatorWegsegment.return_value = Mock(
            IdentificatorWegsegment="108724", BeginBewerking=1, BeginOrganisatie=1
        )
    ...
    def test_list_terreinobjecten_by_huisnummer(self, crab_gateway, crab_service):
    ...
    def test_list_terreinobjecten_by_huisnummer_empty(self, crab_gateway, crab_service):
        crab_service.ListTerreinobjectenByHuisnummerId.return_value = Mock(
            TerreinobjectItem=[]
        )
    ...
    def test_get_terreinobject_by_id(self, crab_gateway, crab_service):
        crab_service.GetTerreinobjectByIdentificatorTerreinobject.return_value = Mock(
    ...
    def test_get_terreinobject_by_unexisting_id(self, crab_gateway, crab_service):
        crab_service.GetTerreinobjectByIdentificatorTerreinobject.return_value = None
        with pytest.raises(GatewayResourceNotFoundException):
            crab_gateway.get_terreinobject_by_id(-1)

    def test_list_percelen_by_huisnummer(self, crab_gateway, crab_service):
        crab_service.ListPercelenByHuisnummerId.return_value = Mock(PerceelItem=[Mock()])
    ...
    def test_list_percelen_by_huisnummer_empty(self, crab_gateway, crab_service):
        crab_service.ListPercelenByHuisnummerId.return_value = Mock(PerceelItem=[])
    ...
    def test_get_perceel_by_id(self, crab_gateway, crab_service):
        crab_service.GetPerceelByIdentificatorPerceel.return_value = Mock(
            IdentificatorPerceel="13040C1747/00G002", BeginBewerking=1, BeginOrganisatie=1
        )
    ...
    def test_list_gebouwen_by_huisnummer_empty(self, crab_gateway, crab_service):
        crab_service.ListGebouwenByHuisnummerId.return_value = Mock(GebouwItem=[])
    ...
    def test_list_subadressen_by_huisnummer(self, crab_gateway, crab_service):
        crab_service.ListSubadressenWithStatusByHuisnummerId.return_value = Mock(
            SubadresWithStatusItem=[Mock(SubadresId=1)]
        )
    ...
    def test_list_subadressen_by_huisnummer_empty(self, crab_gateway, crab_service):
        crab_service.ListSubadressenWithStatusByHuisnummerId.return_value = Mock(
            SubadresWithStatusItem=[]
        )
    ...
    def test_list_adresposities_by_huisnummer_empty(self, crab_gateway, crab_service):
        crab_service.ListAdrespositiesByHuisnummerId.return_value = Mock(
            AdrespositieItem=[]
        )
    ...
    def test_list_adresposities_by_nummer_and_straat(self, crab_gateway, crab_service):
    ...
    def test_list_adresposities_by_nummer_and_straat_empty(
        self, crab_gateway, crab_service
    ):
        crab_service.ListAdrespositiesByHuisnummer.return_value = Mock(
            AdrespositieItem=[]
    ...
    def test_list_adresposities_by_subadres_empty(self, crab_gateway, crab_service):
        crab_service.ListAdrespositiesBySubadresId.return_value = Mock(
            AdrespositieItem=[]
        )
    ...
    def test_list_adresposities_by_subadres_and_huisnummer(
        self, crab_gateway, crab_service
    ):
    ...
    def test_list_adresposities_by_unexisting_subadres_and_huisnummer(
        ...
        crab_service.ListAdrespositiesBySubadres.return_value = Mock(AdrespositieItem=[])
    ...
    def test_get_adrespositie_by_unexisting_id(self, crab_gateway, crab_service):
...
class TestGemeente:
    ...
    @pytest.mark.skipif(not six.PY2, reason="This test only works on python 2.x")
    def test_unicode_py2(self):
        g = Gemeente(92, "Biévène", 23009, Gewest(2))
        assert "Biévène (92)".encode() == str(g)

    @pytest.mark.skipif(not six.PY3, reason="This test only works on python 3.x")
...
class TestDeelgemeente:
    ...
    def test_gemeente(self, crab_gateway, crab_service):
        crab_service.GetGemeenteByNISGemeenteCode.return_value = Mock(
            GemeenteId=1,
            GewestId=1,
            NisGemeenteCode=45062,
            BeginBewerking=1,
            BeginOrganisatie=1,
            GemeenteNaam="Horebeke",
        )
        dg = Deelgemeente("45062A", "Sint-Maria-Horebeke", 45062)
...
class TestTaal:
    def test_fully_initialised(self):
        t = Taal("nl", "Nederlands", "Nederlands.")
        assert t.id == "nl"
...
class TestAardadres:
    def test_repr(self):
        a = Aardadres("1", "subAdres", "Aanduiding van een plaats op een huisnummer")
        assert (
...
class TestAardgebouw:
    def test_repr(self):
        a = Aardgebouw("3", "virtueel gebouw", "gbg afgezoomd met virtuele gvl")
        assert (
            "Aardgebouw(3, 'virtueel gebouw', 'gbg afgezoomd met virtuele gvl')"
            == repr(a)
        )
...
class TestAardwegobject:
    def test_repr(self):
        a = Aardwegobject("1", "taTEL", "Wegverbinding volgens TeleAtlas.")
        assert "Aardwegobject(1, 'taTEL', 'Wegverbinding volgens TeleAtlas.')" == repr(a)


class TestAardterreinobject:
    def test_repr(self):
        a = Aardterreinobject("1", "kadPerceel", "Perceel volgens het Kadaster.")
        assert (
...
class TestStraat:
    ...
    def test_lazy_load(self, crab_gateway, crab_service):
        crab_service.ListStatusStraatnamen.return_value = Mock(CodeItem=[Mock(Code=3)])
        crab_service.GetStraatnaamWithStatusByStraatnaamId.return_value = Mock(
            StraatnaamId=1,
            BeginBewerking=1,
            BeginOrganisatie=1,
            StraatnaamLabel="Acacialaan",
            Straatnaam="Acacialaan",
            TaalCode="nl",
            StraatnaamTweedeTaal=None,
            TaalCodeTweedeTaal=None,
        )
        crab_service.GetGemeenteByGemeenteId.return_value = Mock(
            GemeenteId=1, GewestId=1, BeginBewerking=1, BeginOrganisatie=1
        )
    ...
    def test_taal(self, crab_gateway, crab_service):
        ...
        crab_service.GetGemeenteByGemeenteId.return_value = Mock(
            GemeenteId=1, GewestId=1, BeginBewerking=1, BeginOrganisatie=1, TaalCode="nl"
        )
        s = Straat(1, "Acacialaan", 1, 3, None, None, None, None)
        s.set_gateway(crab_gateway)
        taal = s.taal
    ...
    def test_bounding_box(self, crab_gateway, crab_service):
        ...
        crab_service.GetWegsegmentByIdentificatorWegsegment.return_value = Mock(
            IdentificatorWegsegment="108724",
            BeginBewerking=1,
            BeginOrganisatie=1,
...
class TestHuisnummer:
    ...
    def test_lazy_load(self, crab_gateway, crab_service):
        crab_service.ListStatusHuisnummers.return_value = Mock(CodeItem=[Mock(Code=3)])
        crab_service.GetStraatnaamWithStatusByStraatnaamId.return_value = Mock(
        ...
        assert isinstance(h.metadata, Metadata)
        assert h.metadata.begin_datum is not None
        assert h.metadata.begin_tijd is not None
        assert isinstance(h.metadata.begin_bewerking, Bewerking)
        assert int(h.metadata.begin_bewerking.id) == 1
        assert isinstance(h.metadata.begin_organisatie, Organisatie)
...
class TestWegobject:
    ...
    def test_aard(self, crab_gateway, crab_service):
        crab_service.ListAardWegobjecten.return_value = Mock(CodeItem=[Mock(Code=4)])
    ...
    def test_lazy_load(self, crab_gateway, crab_service):
        crab_service.ListAardWegobjecten.return_value = Mock(CodeItem=[Mock(Code=4)])
        crab_service.GetWegobjectByIdentificatorWegobject.return_value = Mock(
            IdentificatorWegobject="53839893",
            BeginBewerking=1,
            BeginOrganisatie=1,
            CenterX=150753.46,
            CenterY=200148.41,
        ...
        assert isinstance(w.metadata, Metadata)
        assert w.metadata.begin_datum is not None
        assert w.metadata.begin_tijd is not None
        assert isinstance(w.metadata.begin_bewerking, Bewerking)
        assert int(w.metadata.begin_bewerking.id) == 1
        assert isinstance(w.metadata.begin_organisatie, Organisatie)
...
class TestWegsegment:
 ...
 150548.592075631 200754.511565369)"""
    ...
    def test_status(self, crab_gateway, crab_service):
        crab_service.ListStatusWegsegmenten.return_value = Mock(CodeItem=[Mock(Code=4)])
...
class TestTerreinobject:
    ...
    def test_lazy_load(self, crab_gateway, crab_service):
        ...
        crab_service.ListAardTerreinobjecten.return_value = Mock(CodeItem=[Mock(Code=1)])
        ...
        assert isinstance(t.metadata, Metadata)
        assert t.metadata.begin_datum is not None
        assert t.metadata.begin_tijd is not None
        assert isinstance(t.metadata.begin_bewerking, Bewerking)
...
class TestPerceel:
    ...
    def test_huisnummers(self, crab_gateway, crab_service):
        ...
        assert [h.id for h in hnrs] == [
            h.id for h in crab_gateway.list_huisnummers_by_perceel("13040C1747/00G002")
        ]
    ...
    def test_postadressen(self, crab_gateway, crab_service):
        ...
        crab_service.GetHuisnummerWithStatusByHuisnummerId.return_value = Mock(
            HuisnummerId=1, BeginBewerking=1, BeginOrganisatie=1, StatusHuisnummer=3
        )
        crab_service.ListStatusHuisnummers.return_value = Mock(CodeItem=[Mock(Code="3")])
        crab_service.GetPostadresByHuisnummerId.return_value = Mock(
            Postadres="Steenweg op Oosthoven 51, 2300 Turnhout"
...
class TestGebouw:
 ...
 190712.36432739347 224668.5216938965))"""
    ...
    def test_lazy_load(self, crab_gateway, crab_service):
        crab_service.ListAardGebouwen.return_value = Mock(CodeItem=[Mock(Code=1)])
        crab_service.ListStatusGebouwen.return_value = Mock(CodeItem=[Mock(Code=4)])
        crab_service.ListGeometriemethodeGebouwen.return_value = Mock(
            CodeItem=[Mock(Code=3)]
        )
        crab_service.GetGebouwByIdentificatorGebouw.return_value = Mock(
            IdentificatorGebouw=1538575,
            BeginBewerking=1,
            BeginOrganisatie=1,
...
class TestSubadres:
    ...
    def test_lazy_load(self, crab_gateway, crab_service):
        ...
        crab_service.GetSubadresWithStatusBySubadresId.return_value = Mock(
            SubadresId=1120936, BeginBewerking=1, BeginOrganisatie=1, AardSubadres=2
        )
        crab_service.ListAardSubadressen.return_value = Mock(CodeItem=[Mock(Code=2)])
        s = Subadres(1120936, "B", 3)
        s.set_gateway(crab_gateway)
        assert s.id == 1120936
        assert int(s.status.id) == 3
...
class TestAdrespositie:
    def test_fully_initialised(self):
        a = Adrespositie(
            ...
            Aardadres("1", "subAdres", "Aanduiding van een plaats op een huisnummer"),
            Metadata("1830-01-01 00:00:00", "", None, None),
        )
        assert a.id == 4087928
    ...
    def test_lazy_load(self, crab_gateway, crab_service):
        crab_service.GetAdrespositieByAdrespositieId.return_value = Mock(
            AdrespositieId=4428005,
            BeginBewerking=1,
            BeginOrganisatie=1,
            Geometrie="POINT (74414.91 225777.36)",
            AardAdres=2,
            BeginDatum="1830-01-01 00:00:00",
        )
        crab_service.ListAardAdressen.return_value = Mock(CodeItem=[Mock(Code=2)])
