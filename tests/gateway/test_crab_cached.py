...
class TestCrabCachedGateway:
    ...
    def test_cache_is_configured(self, crab_gateway):
        ...
        assert isinstance(crab_gateway.caches["permanent"].backend, MemoryBackend)
    ...
    def test_get_provincie_by_id(self, crab_gateway):
        ...
        assert (
            crab_gateway.caches["permanent"].get("GetProvincieByProvincieNiscode#10000")
            == res
        )

    def test_list_gemeenten_default_is_vlaanderen(self, crab_gateway, crab_service):
    ...
    def test_get_gemeente_by_niscode(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, Gemeente)
        assert (
            crab_gateway.caches["long"].get("GetGemeenteByNISGemeenteCode#11001") == res
        )
    ...
    def test_list_deelgemeenten_by_gemeente(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["permanent"].get("ListDeelgemeentenByGemeenteId#45062")
            == res
        )
    ...
    def test_get_deelgemeente_by_id(self, crab_gateway):
        ...
        assert (
            crab_gateway.caches["permanent"].get("GetDeelgemeenteByDeelgemeenteId#45062A")
            == res
        )
    ...
    def test_list_aardgebouwen_different_sort(self, crab_gateway, crab_service):
        crab_service.ListAardGebouwen.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_aardwegobjecten_different_sort(self, crab_gateway, crab_service):
        crab_service.ListAardWegobjecten.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_aardterreinobjecten_different_sort(self, crab_gateway, crab_service):
        crab_service.ListAardTerreinobjecten.return_value = Mock(CodeItem=[Mock()])
        ...
        assert (
            crab_gateway.caches["permanent"].get("ListAardTerreinobjecten#1") == NO_VALUE
        )
    ...
    def test_list_statushuisnummers_different_sort(self, crab_gateway, crab_service):
        crab_service.ListStatusHuisnummers.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_statussubadressen_different_sort(self, crab_gateway, crab_service):
        crab_service.ListStatusSubadressen.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_statusstraatnamen_different_sort(self, crab_gateway, crab_service):
        crab_service.ListStatusStraatnamen.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_statuswegsegmenten_different_sort(self, crab_gateway, crab_service):
        crab_service.ListStatusWegsegmenten.return_value = Mock(CodeItem=[Mock()])
        ...
        assert (
            crab_gateway.caches["permanent"].get("ListStatusWegsegmenten#1") == NO_VALUE
        )
    ...
    def test_list_geometriemethodewegsegmenten(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["permanent"].get("ListGeometriemethodeWegsegmenten#1")
            == res
        )
    ...
    def test_list_geometriemethodewegsegmenten_different_sort(
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["permanent"].get("ListGeometriemethodeWegsegmenten#2")
            == res
        )
        from dogpile.cache.api import NO_VALUE
    ...
    def test_list_statusgebouwen_different_sort(self, crab_gateway, crab_service):
        crab_service.ListStatusGebouwen.return_value = Mock(CodeItem=[Mock()])
    ...
    def test_list_geometriemethodegebouwen(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["permanent"].get("ListGeometriemethodeGebouwen#1") == res
        )

    def test_list_geometriemethodegebouwen_different_sort(
        self, crab_gateway, crab_service
    ):
        crab_service.ListGeometriemethodeGebouwen.return_value = Mock(CodeItem=[Mock()])
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["permanent"].get("ListGeometriemethodeGebouwen#2") == res
        )
        from dogpile.cache.api import NO_VALUE

        assert (
            crab_gateway.caches["permanent"].get("ListGeometriemethodeGebouwen#1")
            == NO_VALUE
        )
    ...
    def test_list_herkomstadrespositie_different_sort(self, crab_gateway, crab_service):
        crab_service.ListHerkomstAdresposities.return_value = Mock(CodeItem=[Mock()])
        ...
        assert (
            crab_gateway.caches["permanent"].get("ListHerkomstAdresposities#1")
            == NO_VALUE
        )
    ...
    def test_list_straten(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["long"].get("ListStraatnamenWithStatusByGemeenteId#11")
            == res
        )
        ...
        assert isinstance(r, list)
        assert (
            crab_gateway.caches["long"].get("ListStraatnamenWithStatusByGemeenteId#21")
            == r
        )
    ...
    def test_list_straten_different_sort(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["long"].get("ListStraatnamenWithStatusByGemeenteId#12")
            == res
        )
        gem = Gemeente(2, None, None, None)
        ...
        assert isinstance(r, list)
        assert (
            crab_gateway.caches["long"].get("ListStraatnamenWithStatusByGemeenteId#22")
            == r
        )
        from dogpile.cache.api import NO_VALUE
    ...
    def test_get_straat_by_id(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["long"].get("GetStraatnaamWithStatusByStraatnaamId#1")
            == res
        )
    ...
    def test_list_huisnummers_by_straat(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["short"].get("ListHuisnummersWithStatusByStraatnaamId#11")
            == res
        )
        ...
        assert isinstance(r, list)
        assert (
            crab_gateway.caches["short"].get("ListHuisnummersWithStatusByStraatnaamId#21")
            == r
        )
    ...
    def test_list_huisnummers_by_perceel(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["short"].get(
                "ListHuisnummersWithStatusByIdentificatorPerceel#13040C1747/00G0021"
            )
            == res
        )
        ...
        assert (
            crab_gateway.caches["short"].get(
                "ListHuisnummersWithStatusByIdentificatorPerceel#13040C1747/00H0021"
            )
            == r
        )

    def test_list_huisnummers_by_straat_different_sort(self, crab_gateway, crab_service):
        crab_service.ListHuisnummersWithStatusByStraatnaamId.return_value = Mock(
            HuisnummerWithStatusItem=[Mock(HuisnummerId=1)]
        )
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["short"].get("ListHuisnummersWithStatusByStraatnaamId#12")
            == res
        )
        straat = Straat(2, None, None, None, None, None, None, None)
        ...
        assert isinstance(r, list)
        assert (
            crab_gateway.caches["short"].get("ListHuisnummersWithStatusByStraatnaamId#22")
            == r
        )
    ...
    def test_get_huisnummer_by_id(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["short"].get("GetHuisnummerWithStatusByHuisnummerId#1")
            == res
        )
    ...
    def test_get_huisnummer_by_nummer_and_straat(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, Huisnummer)
        assert (
            crab_gateway.caches["short"].get("GetHuisnummerWithStatusByHuisnummer#11")
            == res
        )
    ...
    def test_get_wegobject_by_id(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["short"].get(
                "GetWegobjectByIdentificatorWegobject#53839893"
            )
            == res
        )
    ...
    def test_get_wegsegment_by_id(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["short"].get(
                "GetWegsegmentByIdentificatorWegsegment#108724"
            )
            == res
        )
    ...
    def test_list_terreinobjecten_by_huisnummer(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["short"].get("ListTerreinobjectenByHuisnummerId#1") == res
        )
        huisnummer = Huisnummer(1, None, None, None)
    ...
    def test_get_terreinobject_by_id(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["short"].get(
                "GetTerreinobjectByIdentificatorTerreinobject#13040_C_1747_G_002_00"
            )
            == res
        )
    ...
    def test_get_perceel_by_id(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["short"].get(
                "GetPerceelByIdentificatorPerceel#13040C1747/00G002"
            )
            == res
        )
    ...
    def test_get_gebouw_by_id(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["short"].get("GetGebouwByIdentificatorGebouw#1538575")
            == res
        )
    ...
    def test_list_subadressen_by_huisnummer(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["short"].get(
                "ListSubadressenWithStatusByHuisnummerId#129462"
            )
            == res
        )
    ...
    def test_get_subadres_by_id(self, crab_gateway, crab_service):
        ...
        assert (
            crab_gateway.caches["short"].get("GetSubadresWithStatusBySubadresId#1120934")
            == res
        )
    ...
    def test_list_adresposities_by_huisnummer(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["short"].get("ListAdrespositiesByHuisnummerId#1") == res
        )
    ...
    def test_list_adresposities_by_subadres(self, crab_gateway, crab_service):
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["short"].get("ListAdrespositiesBySubadresId#1120936")
            == res
        )
    ...
    def test_list_adresposities_by_subadres_and_huisnummer(
        ...
        assert isinstance(res, list)
        assert (
            crab_gateway.caches["short"].get("ListAdrespositiesBySubadres#A129462") == res
        )
        huisnummer = Huisnummer(129462, None, None, None)
    ...
    def test_get_adrespositie_by_id(self, crab_gateway, crab_service):
        ...
        assert str(
            crab_gateway.caches["short"].get("GetAdrespositieByAdrespositieId#4428005")
        ) == str(res)
    ...
    def test_get_postadres_by_huisnummer(self, crab_gateway, crab_service):
        ...
        assert str(
            crab_gateway.caches["short"].get("GetPostadresByHuisnummerId#1")
        ) == str(res)
    ...
    def test_get_postadres_by_subadres(self, crab_gateway, crab_service):
        ...
        assert str(
            crab_gateway.caches["short"].get("GetPostadresBySubadresId#1120936")
        ) == str(res)
